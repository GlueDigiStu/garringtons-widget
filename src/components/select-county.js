            ...
            <div className='select-region-container'>
                ...
                <div className='prime-only-container'>
                    <img alt="" onClick={this.handleInfoBoxClick} style={{width: "15px", marginRight: '10px'}}
                         src="info.svg"/>
                    <p className="info-window" style={{display: this.state.displayInfo}}>A prime location is defined as
                        an area where property values are at least 20% higher than the regional average.</p>
                    <label
